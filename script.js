...
const messages = [
    "haii zia nadira aqila akuu ingin menyampaikan sesuatu:",
    "aku ingin kamuu jadi pacarku",
    "apakah kamuu mau jadi pacarku?",
    "jika ingin balas pesan diatas dm ig @gddpppn",
    "tapi jangan lupa di follback dulu",
    "-pencet hadiah-"
];
